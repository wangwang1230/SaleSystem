<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
       ...
       <footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">mras</a> 2012</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">gm_mras</a></p>
		</footer>
